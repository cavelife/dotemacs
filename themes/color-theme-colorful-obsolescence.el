...
(defun color-theme-colorful-obsolescence ()
  ...
  (color-theme-install
   '(color-theme-colorful-obsolescence
     ...
     (mode-line ((t (:background "royal blue"))))
     (mode-line-buffer-id ((t (:foreground "white"))))
     (mode-line-emphasis ((t (:bold t :weight bold))))
     (mode-line-highlight ((t (:foreground "#b9fc6d"))))
     (mode-line-inactive ((t (:background "snow4" :foreground "#444"))))
     (mouse ((t (nil))))
     ...
     (slime-repl-input-face ((t (:bold t :background "dark olive green" :weight bold))))
